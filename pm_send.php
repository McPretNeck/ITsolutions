...
?>
	<form name="formulier" method="post" action="pm_verwerk.php" >
		<table border="1" width="700">
			<tr>
				<td width="30%">Ontvanger:</td><td width="70%">
				<select name="naar">
				<?php
					$id = $_SESSION['ID'];
			...
			<tr>
				<td width="30%">Onderwerp:</td><td width="70%"><input name="onderwerp" type="text" size="25" />
				</td>
			</tr>
<?php
if
($_SESSION['rol']==1){ ?>
	<tr>
		<td width="30%">Admin bericht:</td><td width="70%">
			<select name="admin">
